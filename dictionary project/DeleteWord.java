            ...
            public void actionPerformed(ActionEvent e)
            {
                if (DeleteWord.this.tfWord.getText().length() > 0)
                {
                    ...
                    if (!done) {
                        ...
                        JOptionPane.showMessageDialog(DeleteWord.this, "Word Deleted Successfully!", "Delete Word"
                                ,1);
                    }
                }
                else
                {
                    JOptionPane.showMessageDialog(DeleteWord.this, "Please enter word from dictionary!", "AddWord", 0);
                }
            }
        });
